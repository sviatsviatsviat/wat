...
// to deny. Handler errors exit 1 under Cursor's default fail-open policy. Hook
// stdout JSON is encoded internally from Output (sealed; only this package
// implements it). Payloads must include hook_event_name on the wire.
//
