...
// Output is the response for FileChanged events.
...
func (o output) Encode() ([]byte, int, error) {
	...
	return event.MarshalHookOutput(event.FileChanged, o.encodeInto)
}

// Merge combines other into this FileChanged output.
