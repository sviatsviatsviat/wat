...
// Output is the response for ConfigChange events.
...
func (o output) encodeInto(top, _ map[string]any) {
...
func (o output) Encode() ([]byte, int, error) {
	return event.MarshalHookOutput(event.ConfigChange, o.encodeInto)
}

// Merge combines other into this ConfigChange output.
