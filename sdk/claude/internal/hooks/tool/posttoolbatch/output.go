...
// Output is the response for PostToolBatch events.
...
func (o output) Encode() ([]byte, int, error) {
	return event.MarshalHookOutput(event.PostToolBatch, o.encodeInto)
}

// Merge combines other into this PostToolBatch output.
