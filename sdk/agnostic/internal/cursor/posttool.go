...
func RegisterPostTool(r *run.Registry, fn model.PostToolHandler) {
	...
	sdkcursor.UseHooks(r).PostToolUse(func(ctx context.Context, hook run.Hook[sdkcursor.PostToolUse], native sdkcursor.PostToolResults) (sdkcursor.PostToolOutput, error) {
