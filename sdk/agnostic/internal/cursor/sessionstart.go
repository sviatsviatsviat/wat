...
func RegisterSessionStart(fn model.SessionStartHandler) {
	...
	sdkcursor.Adapter().SessionStart(func(ctx context.Context, hook sdkcursor.Hook[sdkcursor.SessionStart], native sdkcursor.SessionStartResults) (sdkcursor.SessionStartOutput, error) {
