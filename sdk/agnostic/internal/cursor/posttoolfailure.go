...
func RegisterPostToolFailure(fn model.PostToolFailureHandler) {
	...
	sdkcursor.Adapter().PostToolUseFailure(func(ctx context.Context, hook sdkcursor.Hook[sdkcursor.PostToolUseFailure], native sdkcursor.PostToolResults) (sdkcursor.PostToolOutput, error) {
