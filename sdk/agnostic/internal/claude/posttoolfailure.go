...
func RegisterPostToolFailure(fn model.PostToolFailureHandler) {
	...
	sdkclaude.Adapter().PostToolUseFailure(func(ctx context.Context, hook sdkclaude.Hook[sdkclaude.PostToolUseFailure], native sdkclaude.PostToolUseFailureResults) (sdkclaude.PostToolUseOutput, error) {
...
func mapPostToolUseFailure(e sdkclaude.PostToolUseFailure, raw []byte) *model.PostToolFailureEvent {
