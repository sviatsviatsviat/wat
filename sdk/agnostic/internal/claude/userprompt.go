...
func RegisterUserPrompt(fn model.UserPromptHandler) {
	...
	sdkclaude.Adapter().UserPromptSubmit(func(ctx context.Context, hook sdkclaude.Hook[sdkclaude.UserPromptSubmit], _ sdkclaude.UserPromptSubmitResults) (sdkclaude.UserPromptSubmitOutput, error) {
