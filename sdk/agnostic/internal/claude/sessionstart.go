...
func RegisterSessionStart(fn model.SessionStartHandler) {
	...
	new(sdkclaude.Chain).SessionStart(func(ctx context.Context, hook sdkclaude.Hook[sdkclaude.SessionStart], native sdkclaude.SessionStartResults) (sdkclaude.SessionStartOutput, error) {
...
func mapSessionStart(e sdkclaude.SessionStart, raw []byte) *model.SessionStartEvent {
...
func (r sessionStartResult) IsZero() bool { return sdkclaude.IsZeroOutput(r.native) }
