...
func RegisterPostTool(fn model.PostToolHandler) {
	...
	sdkclaude.Adapter().PostToolUse(func(ctx context.Context, hook sdkclaude.Hook[sdkclaude.PostToolUse], native sdkclaude.PostToolUseResults) (sdkclaude.PostToolUseOutput, error) {
