...
func RegisterStop(fn model.StopHandler) {
	...
	sdkcopilot.Adapter().AgentStop(func(ctx context.Context, hook sdkcopilot.Hook[sdkcopilot.AgentStop], native sdkcopilot.StopResults) (sdkcopilot.StopOutput, error) {
...
func RegisterSubagentStop(fn model.StopHandler) {
	...
	sdkcopilot.Adapter().SubagentStop(func(ctx context.Context, hook sdkcopilot.Hook[sdkcopilot.SubagentStop], native sdkcopilot.StopResults) (sdkcopilot.StopOutput, error) {
