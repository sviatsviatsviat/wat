...
func RegisterPreCompact(registry *run.Registry, fn model.PreCompactHandler) {
	if fn == nil {
		return
	}
	sdkcopilot.UseHooks(registry).PreCompact(func(ctx context.Context, hook run.Hook[sdkcopilot.PreCompact]) error {
