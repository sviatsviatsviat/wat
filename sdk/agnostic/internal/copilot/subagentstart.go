...
func RegisterSubagentStart(fn model.SubagentStartHandler) {
	...
	sdkcopilot.Adapter().SubagentStart(func(ctx context.Context, hook sdkcopilot.Hook[sdkcopilot.SubagentStart], _ sdkcopilot.SubagentStartResults) (sdkcopilot.SubagentStartOutput, error) {
