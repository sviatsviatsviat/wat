...
func TestDecode_SubagentStart(t *testing.T) {
	ev, err := runtime.Codec.Decode([]byte(`{"hook_event_name":"SubagentStart","session_id":"s","timestamp":"2026-01-01T00:00:00Z","cwd":"/w","transcript_path":"/t","agent_name":"explore","agent_display_name":"Explore","agent_description":"search codebase"}`))
	if err != nil {
		t.Fatal(err)
	}
	e, ok := ev.(Event)
