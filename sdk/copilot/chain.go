...
func (c *chain) UserPromptSubmitted(fn func(context.Context, UserPromptSubmitted) error) *chain {
...
func (c *chain) SubagentStart(fn func(context.Context, SubagentStart, SubagentStartResults) (SubagentStartOutput, error)) *chain {
...
func (c *chain) PreCompact(fn func(context.Context, PreCompact) error) *chain {
	precompact.RegisterHandler(runtime.DefaultDialect, fn)
	return c
}

// Notification registers a Notification handler on the chain.
func (c *chain) Notification(fn func(context.Context, Notification, NotificationResults) (NotificationOutput, error)) *chain {
	notification.RegisterHandler(runtime.DefaultDialect, fn)
	return c
}

// ErrorOccurred registers an ErrorOccurred handler on the chain.
func (c *chain) ErrorOccurred(fn func(context.Context, ErrorOccurred) error) *chain {
