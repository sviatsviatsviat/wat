...
// have a doc comment (AST Doc on the declaration or group), matching revive's
// exported rule. Struct/interface fields are not counted. Test files,
// testdata, and generated files are excluded.
//
