...
func TestTranslate_claudeToCursor(t *testing.T) {
	out, warns, err := Translate([]byte(claudeSettings), agenthooks.Claude, agenthooks.Cursor)
	if err != nil {
		t.Fatal(err)
	}
	var f struct {
...
func TestTranslate_claudeToCopilot(t *testing.T) {
	out, _, err := Translate([]byte(claudeSettings), agenthooks.Claude, agenthooks.Copilot)
	if err != nil {
		t.Fatal(err)
	}
	var f struct {
...
func TestTranslate_cursorToClaude(t *testing.T) {
	out, _, err := Translate([]byte(cursorSettings), agenthooks.Cursor, agenthooks.Claude)
	if err != nil {
		t.Fatal(err)
	}
	s := string(out)
...
func TestTranslate_copilotAnchoredRegex(t *testing.T) {
	t.Run("copilot_to_claude", func(t *testing.T) {
		...
		out, warns, err := Translate([]byte(raw), agenthooks.Copilot, agenthooks.Claude)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("claude_to_copilot", func(t *testing.T) {
		...
		out, _, err := Translate([]byte(raw), agenthooks.Claude, agenthooks.Copilot)
		if err != nil {
			t.Fatal(err)
		}
...
func TestTranslate_claudeIfRule(t *testing.T) {
	...
	out, warns, err := Translate([]byte(raw), agenthooks.Claude, agenthooks.Cursor)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTranslate_sameDialect(t *testing.T) {
	out, warns, err := Translate([]byte(claudeSettings), agenthooks.Claude, agenthooks.Claude)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTranslate_timeoutDefaultWarning(t *testing.T) {
	...
	out, warns, err := Translate([]byte(raw), agenthooks.Claude, agenthooks.Copilot)
	if err != nil {
		t.Fatal(err)
	}
	found := false
...
func TestTranslate_cursorDedicatedEvent(t *testing.T) {
	out, warns, err := Translate([]byte(cursorDedicatedSettings), agenthooks.Cursor, agenthooks.Claude)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTranslate_droppedRawFieldsWarning(t *testing.T) {
	...
	_, warns, err := Translate([]byte(raw), agenthooks.Claude, agenthooks.Copilot)
	if err != nil {
		t.Fatal(err)
	}
	found := false
